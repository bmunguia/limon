...
from pymeshb.mesh.gmf.libgmf import read_mesh as _read_mesh
from pymeshb.mesh.gmf.libgmf import write_mesh as _write_mesh
...
def read_mesh(
    ...
    try:
        ...
        coords, elms, bnds, sol = _read_mesh(meshpath, solpath, labelpath,
                                                   read_sol)
